...
void quad::fill_vert_coord() {
  tr[0].v[0].pos = vec2(0.0f, 1.0f);
  tr[0].v[1].pos = vec2(1.0f, 0.0f);
  tr[0].v[2].pos = vec2(0.0f, 0.0f);

  tr[1].v[0].pos = vec2(0.0f, 1.0f);
  tr[1].v[1].pos = vec2(1.0f, 1.0f);
  tr[1].v[2].pos = vec2(1.0f, 0.0f);
}
