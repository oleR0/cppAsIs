...
std::istream& DECLSPEC operator>>(std::istream& is, vertex&);
std::istream& DECLSPEC operator>>(std::istream& is, triangle&);
...
void DECLSPEC render_triangle(const triangle&);
void DECLSPEC swap_buffers();
};  // namespace TME
